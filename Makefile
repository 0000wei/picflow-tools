...
lint-root-files:
	...
	@ALLOWED_FILES="STRUCTURE-RULES.md AGENTS.md README.md .gitignore vercel.json Makefile PROGRESS.md feature_list.json index.html privacy-policy.html sitemap.xml robots.txt llms.txt mcp.json package.json package-lock.json"; \
